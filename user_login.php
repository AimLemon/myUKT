...
<body>
    <div class="main-container">
        <div class="left-panel">
            ...
            <div class="ukt-text">MyUKT<br>Mahasiswa</div>
            ...
            <form id="loginForm" method="POST" action="user_login.php" style="max-width: 340px;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="create-account" id="toSignUp" style="cursor:pointer;">Create New Account</span>
                    <button type="submit" class="login-btn ms-2">Login</button>
                </div>
            </form>
            <!-- Sign Up Form -->
            <form id="signupForm" method="POST" action="user_login.php" style="max-width: 340px; display:none;">
                <input type="hidden" name="login_type" value="signup">
                <div class="position-relative">
                    <span class="input-icon"><i class="bi bi-person"></i></span>
                    <input type="text" class="form-control ps-5" name="signup_username" placeholder="NIM" required>
                </div>
                <div class="position-relative">
                    <span class="input-icon"><i class="bi bi-person-lines-fill"></i></span>
                    <input type="text" class="form-control ps-5" name="signup_nama" placeholder="Nama Lengkap" required>
                </div>
                <div class="position-relative">
                    <span class="input-icon"><i class="bi bi-envelope"></i></span>
                    <input type="email" class="form-control ps-5" name="signup_email" placeholder="Email" required>
                </div>
                <div class="position-relative">
                    <span class="input-icon"><i class="bi bi-lock"></i></span>
                    <input type="password" class="form-control ps-5" name="signup_password" placeholder="Password" required>
                </div>
                <div class="position-relative">
                    <span class="input-icon"><i class="bi bi-mortarboard"></i></span>
                    <select class="form-control ps-5" name="signup_prodi" required style="padding-left:2.5rem;">
                ...
                <?php if (!empty($signup_error)): ?>
                    <div class="text-danger mb-2"><?= $signup_error ?></div>
                <?php elseif (!empty($signup_success)): ?>
                    <div class="text-success mb-2"><?= $signup_success ?></div>
                <?php endif; ?>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="already-account" id="toLogin" style="cursor:pointer;">I Already Have an Account</span>
                    <button type="submit" class="login-btn ms-2">Sign Up</button>
                </div>
            </form>
        </div>
        <div class="right-panel">
            <img id="mainImage" src="https://i.ibb.co/0jzjK6y/mahasiswa-3d.png" alt="Mahasiswa" class="img-figure">
        </div>
    </div>
    <script>
        // Tab switching logic
        ...
        // Ganti gambar Login dan Sign Up
        const loginImg = "duduk.jpeg";
        const signupImg = "berdiri.jpeg";
